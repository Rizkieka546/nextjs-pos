...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-md border border-gray-800">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <tr
    ...
    className={cn(
      ...
      "hover:bg-gray-800",
      "data-[state=selected]:bg-gray-800",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-12 px-4 text-left align-middle text-sm font-semibold",
      "text-gray-300",
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "p-4 align-middle text-gray-100",
      "[&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
